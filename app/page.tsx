...
export default function Home() {
  ...
  <p style={{ fontSize: 13, color: '#6e6860', fontStyle: 'italic' }}>The AI era has brought out the "Bob the Builder" in me. Ingredients: 2 teaspoons of prompts, 1 of DevTools, and a generous amount of Claude.</p>
</div>
