  ...
  return (
    <div style={{ maxWidth: 680, margin: '0 auto', padding: '0 32px' }}>
      ...
      <article style={{ padding: '40px 0 80px' }}>
        <p style={{ fontSize: 16, color: '#4a4540', lineHeight: 1.85, marginBottom: 20 }}>My first real memory of understanding what was actually going on in a cricket game is the 2003 World Cup match against Pakistan. Sachin Tendulkar was batting unbelievably, you all remember the upper cuts right. All family members gathered around watching the game, and as it often happens in every Indian household when a big game is on, there was a small team management in ours too, mostly focused on one thing: please somehow negotiate the overs from Wasim Akram, Waqar Younis and Shoaib Akhtar. If I was ever put in charge of getting the next generation hooked on cricket, I would have picked this game. It had everything, plus India winning.</p>
